...
console.log("task 1b:",createMenuItem("hotdogs", 2, "Lunch"));
...
*/
reviews.push({name:"Bryan", rating:5, feedback:"Amazing!"})
...
function getReviewByIndex(array,index) {
  /*Your code here*/
  const report = array[index]["name"] + " gave the restaurant a " + array[index]["rating"] + " star review, and their feedback was: " + array[index]["feedback"];
  return report;
}
